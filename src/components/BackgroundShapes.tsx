...
const Cell7 = () => <rect width="75" height="75" x="12.5" y="12.5" fill="rgba(240,74,53,0.05)" />;
...
const shapesConfig: ShapeConfig[] = [
  ...
  { shape: Cell6, weight: 10 },
  { shape: Cell7, weight: 2 },
];
...
export const BackgroundShapes = ({
  ...
  return (
    <svg width="100%" height="100%" preserveAspectRatio="xMidYMid slice" viewBox={`0 0 ${width} ${height}`} className={className}>
      {shapes}
    </svg>
  );
};
